...
# Join the Cluster
echo “To join the cluster, Copy from the Master node the output of this command "kubeadm token create --print-join-command" and paste in the intending worker node